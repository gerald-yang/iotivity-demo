...
std::shared_ptr<OCResource> sensorResourceP;
std::shared_ptr<OCResource> ledResourceA;
std::shared_ptr<OCResource> ledResourceP;
std::shared_ptr<OCResource> lcdResourceA;
std::shared_ptr<OCResource> lcdResourceP;
std::shared_ptr<OCResource> buzzerResourceA;
std::shared_ptr<OCResource> buzzerResourceP;
std::shared_ptr<OCResource> buttonResourceA;
std::shared_ptr<OCResource> buttonResourceP;
...
{
	if(cmd == 1)
		buttonResourceP->observe(observe_type, QueryParamsMap(), &onObserveButton);
	else if(cmd == 2)
